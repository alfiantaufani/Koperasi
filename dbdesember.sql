...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2021 at 02:39 PM
...
INSERT INTO `tbl_booking` (`id_booking`, `nip`, `tanggal_booking`, `id_produk`, `jumlah`, `status`, `tanggal_ambil`) VALUES
(1, 1802040779, '2021-07-01', 1, 1, 'Bayar Tunai Selesai', '2021-07-07'),
(2, 1802040820, '2021-07-01', 7, 1, 'Bayar Tunai Selesai', '2021-07-22'),
(3, 1802040779, '2021-07-01', 7, 1, '', '2021-07-08'),
(4, 1802040820, '2021-07-01', 7, 1, 'Menunggu Pembayaran', '2021-07-08'),
(11, 1802040820, '2021-08-02', 7, 1, 'Menunggu Pembayaran', '2021-08-03'),
(12, 1802040820, '2021-08-02', 7, 1, 'Menunggu Pembayaran', '2021-08-03');
...
--
-- Dumping data for table `tbl_dt_transaksi`
--

INSERT INTO `tbl_dt_transaksi` (`id_dt`, `id_transaksi`, `id_produk`, `jumlah`, `harga`) VALUES
(1, 61, 4, 1, 6000),
(2, 62, 2, 1, 5500),
(24, 63, 1, 1, 6500),
(25, 64, 1, 1, 6500),
...
INSERT INTO `tbl_transaksi` (`id_transaksi`, `tanggal_transaksi`, `total_harga`, `id_jenis_pembayaran`, `nip`, `id_booking`, `kode_diskon`) VALUES
(51, '2021-07-26', 6500, 1, 1802040779, '1', '0'),
(52, '2021-07-26', 6500, 2, 1802040779, '1', '0'),
(53, '2021-07-26', 6500, 2, 1802040779, '1', '0'),
(54, '2021-07-26', 6500, 2, 1802040779, '1', '0'),
(61, '2021-07-26', 6000, 2, 0, '', '0'),
(62, '2021-07-26', 5500, 1, 1802040783, '', '0'),
(63, '2021-07-26', 6500, 1, 1802040779, '1', '0'),
(64, '2021-07-27', 6500, 2, 1802040791, '', '0'),
(65, '2021-07-27', 4500, 1, 1802040779, '3', '0'),
(66, '2021-08-01', 5500, 1, 1802040779, '', '0'),
(67, '2021-08-01', 0, 1, 1802040779, '5', '0'),
(68, '2021-08-01', 4500, 1, 1802040820, '2', '0'),
(69, '2021-12-07', 38000, 1, 1802040779, '', '0');
...
--
ALTER TABLE `tbl_booking`
  MODIFY `id_booking` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tbl_dt_transaksi`
  MODIFY `id_dt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `tbl_jenis_pembayaran`
  MODIFY `id_jenis_pembayaran` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_kategori`
--
ALTER TABLE `tbl_kategori`
  MODIFY `id_kategori` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_pemasukan`
--
ALTER TABLE `tbl_pemasukan`
  MODIFY `id_pemasukan` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `tbl_transaksi`
  MODIFY `id_transaksi` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
